...
export class LoadingComponent implements OnInit {
    ...
    @Input() options?: LoadingOptions = {
        ...
        showMessage: false,
        overlay: false,
        fullscreen: true // Por defecto, cuando se usa solo el componente, será fullscreen
    };

    get isFullscreen(): boolean {
        // Si no hay opciones específicas o si se usa el componente directamente sin section, será fullscreen
    ...
    ngOnInit() {
        this.loadingService.isLoading$(this.section).subscribe(
