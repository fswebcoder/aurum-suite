...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, DatePickerModule, FloatLabelModule, IconFieldModule],
  templateUrl: './date-piker.component.html'
})
export class DatePikerComponent implements ControlValueAccessor, OnDestroy, OnInit {
  ...
  ngOnDestroy(): void {
    // Limpiar cualquier suscripción o evento si es necesario
  }
